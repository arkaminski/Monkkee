...
public class SettingsPage extends BasePage {
    public static By BUTTON_SETTINGS = By.xpath("//button[@class = 'user-menu__btn']/ancestor::span[@class = 'ng-scope']//a[@class = 'user-menu__btn']");
    public static By LOGOUT_BUTTON = By.xpath("//button[@class = 'user-menu__btn']");
    public static By LIST_SETTINGS = By.xpath("//li[@ng-class]/ancestor::div[@class = 'd-none d-lg-block']//li");
    public static By LIST_LANGUAGE = By.xpath("//option[@value]/ancestor::div[@class = 'col-lg-9 col-xl-6 col-xxl-5']//option");
    public static By BUTTON_OK = By.xpath("//button[@class = 'btn btn-primary form-button']");
    ...
    public static final By BUTTON_HOME_SETTING = By.xpath("//*[@id = 'Icon_awesome-home']");
